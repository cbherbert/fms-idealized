...
set run_name       = "default_test_${model_type}_hs_${analysis_type}"          # label for run; output dir and working dir are run_name specific
set run_script     = "$cwd/run_dry_hs_psmn.csh"                  # path/name of this run script (for resubmit)
#set echo
