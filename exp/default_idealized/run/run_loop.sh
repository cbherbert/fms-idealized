...
###
#   Define paths for working tree for the run
###
...
# Define counters for the main loop
...
###
# this should need only run_dir, (work_dir, output_dir, reload_file,run_analysis,post_processing_info), init_cond
# and the parameters specific to the loop: irun, ireload
# mpirun and qsub
...
EOF
    ...
    date_name="$($time_stamp -eh)" # generates string date for file name labels
